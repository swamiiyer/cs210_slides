...
\begin{center}
\visible<2->{\includegraphics[scale=0.4]{{./figures/23_tree}.pdf}}
\end{center}
...
\begin{center}
\visible<4->{\includegraphics[scale=0.3]{{./figures/23_tree_perfect_balance}.png}}
\end{center}
\end{frame}
...
\begin{center}
\visible<2->{\includegraphics[scale=0.5]{{./figures/red_black_bst2}.pdf}}
\end{center}
\end{frame}
...
\begin{center}
\visible<2->{\includegraphics[scale=0.4]{{./figures/red_black_bst13}.pdf}}
\end{center}
\end{minipage}
\end{frame}
