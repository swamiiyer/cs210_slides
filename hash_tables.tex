...
\item the ration $N / M$ is called the load factor and is denoted by $\alpha$; it is interpreted as the average number of keys per list
\end{itemize}
\end{frame}
...
\item the ration $N / M$ is called the load factor and is denoted by $\alpha$; it is interpreted as the percentage of array slots that are occupied
\end{itemize}
\end{frame}
