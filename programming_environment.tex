...
On the dock: Web Browser \visible<5->{\includegraphics[height=\myMheight]{figures/web_browser.pdf}}, Editor \visible<5->{\includegraphics[height=\myMheight]{figures/editor.pdf}}, Terminal \visible<5->{\includegraphics[height=\myMheight]{figures/terminal.pdf}}, File manager \visible<5->{\includegraphics[height=\myMheight]{figures/file_manager.pdf}}

\pause\transdissolve\bigskip

To stop the machine, click \visible<6->{\includegraphics[height=\myMheight]{figures/shutdown.pdf}} and select ``Shut Down...''
\end{frame}
...
Use web browser \visible<4->{\includegraphics[height=\myMheight]{figures/web_browser.pdf}} to sign on to Gradescope and upload your project files
\end{frame}
\end{document}
